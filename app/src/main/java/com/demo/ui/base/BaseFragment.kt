...
/**
 * Created by Codiant at 06 Aug 2019.
 */
...
abstract class BaseFragment<T : ViewDataBinding, V : BaseViewModel<*>> : Fragment(),
    ...
    fun setStatusBarColor(color: Int) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            activity!!.window.statusBarColor = ContextCompat.getColor(context!!, color)// set status background white
        }
    }
     ...
     */
    fun ImageView.setImage(url: String, context: Context, placeHolderId: Int = R.mipmap.ic_launcher) {
