...
import com.demo.appUtils.CommonUtils
import com.demo.appUtils.CustomProgressDialog
import com.demo.appUtils.DialogConstant
...
abstract class BaseActivity<T : ViewDataBinding, V : BaseViewModel<*>> : AppCompatActivity(), BaseFragment.Callback,
     ...
     */
    open fun hasPermissions(context: Context, vararg permissions: Array<String>): Boolean = permissions.all {
    ...
    fun setLocale(appLanguage: String) {
        val getLanguage = Resources.getSystem().configuration.locale.getDisplayLanguage(Locale.getDefault())
        if (appLanguage != getLanguage) {
            ...
            cxt.resources.updateConfiguration(configuration,
    ...
    fun setStatusBarColor(color: Int) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            window.statusBarColor = ContextCompat.getColor(this, color)// set status background white
        }
    }
     ...
     */
    fun ImageView.setImage(url: String, context: Context, placeHolderId: Int = R.drawable.ic_launcher_background) {
     ...
     * @param Int setting image id.
     */
    fun CircleImageView.setImage(url: String, context: Context, placeHolderId: Int = R.mipmap.ic_launcher) {
        Glide.with(context).load(url).placeholder(placeHolderId).into(this)
    }
